...
const (
	...
	KVStore_GetPrimary_FullMethodName = "/kvstore.KVStore/GetPrimary"
)
...
type KVStoreClient interface {
	...
	GetPrimary(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*GetPrimaryResponse, error)
}
...
func (c *kVStoreClient) GetPrimary(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*GetPrimaryResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetPrimaryResponse)
	err := c.cc.Invoke(ctx, KVStore_GetPrimary_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type KVStoreServer interface {
	...
	GetPrimary(context.Context, *Empty) (*GetPrimaryResponse, error)
...
func (UnimplementedKVStoreServer) GetPrimary(context.Context, *Empty) (*GetPrimaryResponse, error) {
...
func _KVStore_GetPrimary_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(KVStoreServer).GetPrimary(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: KVStore_GetPrimary_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(KVStoreServer).GetPrimary(ctx, req.(*Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var KVStore_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _KVStore_GetPrimary_Handler,
		},
	},
...
const (
	Replication_Replicate_FullMethodName      = "/kvstore.Replication/Replicate"
	Replication_Heartbeat_FullMethodName      = "/kvstore.Replication/Heartbeat"
	Replication_AnnounceLeader_FullMethodName = "/kvstore.Replication/AnnounceLeader"
)
...
func (c *replicationClient) AnnounceLeader(ctx context.Context, in *AnnounceLeaderRequest, opts ...grpc.CallOption) (*AnnounceLeaderResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AnnounceLeaderResponse)
	err := c.cc.Invoke(ctx, Replication_AnnounceLeader_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedReplicationServer) AnnounceLeader(context.Context, *AnnounceLeaderRequest) (*AnnounceLeaderResponse, error) {
...
func _Replication_AnnounceLeader_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AnnounceLeaderRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ReplicationServer).AnnounceLeader(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Replication_AnnounceLeader_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ReplicationServer).AnnounceLeader(ctx, req.(*AnnounceLeaderRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Replication_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Replication_AnnounceLeader_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "proto/kvstore.proto",
