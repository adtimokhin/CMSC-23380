...
type PutResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Ok            bool                   `protobuf:"varint,1,opt,name=ok,proto3" json:"ok,omitempty"`                                        // true = committed by Raft majority
	RedirectAddr  string                 `protobuf:"bytes,2,opt,name=redirect_addr,json=redirectAddr,proto3" json:"redirect_addr,omitempty"` // non-empty when ok=false and caller hit a non-leader
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_proto_kvstore_proto_rawDesc = "" +
	...
	"\rredirect_addr\x18\x02 \x01(\tR\fredirectAddr\"\x1e\n" +
	"\n" +
	"GetRequest\x12\x10\n" +
	...
	"\n" +
	"primary_id\x18\x02 \x01(\x05R\tprimaryId2\xa8\x01\n" +
	"\aKVStore\x120\n" +
	...
	"\n" +
	"GetPrimary\x12\x0e.kvstore.Empty\x1a\x1b.kvstore.GetPrimaryResponseB\x0eZ\fkvraft/protob\x06proto3"
...
var file_proto_kvstore_proto_depIdxs = []int32{
	...
	2, // 3: kvstore.KVStore.Put:output_type -> kvstore.PutResponse
	4, // 4: kvstore.KVStore.Get:output_type -> kvstore.GetResponse
	5, // 5: kvstore.KVStore.GetPrimary:output_type -> kvstore.GetPrimaryResponse
